...
public class MyBookshelfAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements BookShelfAdapter {
    /* 책꽂이에 책 띄의줌,
    책 ImageView를 누르면 책기록 정보 띄워줌 */
        ...
        void onBind(BookSelected item){
            bookIV.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((MainActivity)MainActivity.mContext).dispBookFragment("my", item);
                }
            });
